...
public class AudioActivity extends Activity  implements MediaPlayer.OnCompletionListener, SeekBar.OnSeekBarChangeListener,MediaPlayer.OnBufferingUpdateListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tx3=(TextView)findViewById(R.id.playsong_name);
    ...
    private void addliniser() {
        if (!playPause) {
            b3.setImageResource(R.drawable.uamp_ic_pause_white);
            if (intialStage)
               /* new Player()
...
//        mediaPlayer.stop();
    ...
    public void  playSong(final int songIndex){
        // Play song
        try {
            if(Globals.isConnected(AudioActivity.this))
            {
                progress.setMessage("Buffering...");
                progress.show();
                progress.setProgressStyle(R.style.MyTheme);
//            progress.getWindow().setBackgroundDrawableResource(R.color.transparent);

                progress.getWindow().setContentView(R.layout.activity_dialog);
...
//                if(intialStage)
                ...
                mediaPlayer.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
                    ...
                    public void onPrepared(MediaPlayer mediaPlayer) {
                        mediaPlayer.start();
                        progress.dismiss();
                        seekbar.setEnabled(true);//Thennzgathin Thiruvilakkaam
                        tx3.setText(Html.fromHtml("<marquee> '"+Globals.list.get(songIndex).getSongName()+"' </marquee>"));
//                        tx3.setText(Html.fromHtml("<marquee> Thennzgathin Thiruvilakkaam </marquee>"));
                        mediaPlayer.setOnCompletionListener(AudioActivity.this);
//                    mediaPlayer.setOnBufferingUpdateListener(AudioActivity.this);
                        b3.setImageResource(R.drawable.uamp_ic_pause_white);
                ...
                Toast.makeText(AudioActivity.this, "No Internet Connection Available", Toast.LENGTH_LONG).show();
