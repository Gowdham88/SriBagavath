...
public class CategoriesListAdapter extends BaseAdapter {
 ...
 int[] Categories_images;
    ...
    public  CategoriesListAdapter(Context context,String[] Categories_names,int[] Categories_images){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.Img_category.setImageResource(this.Categories_images[position]);
